...
# Scenarios:
#  - Ideal for setting up resources or state needed only for this specific agent's run
...
#  - modifying the invocation context before the core logic uses it.
...
#  - modifying final state, or augmenting/replacing the agent's final output.
